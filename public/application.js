...
var loadSurveysTemplate = __webpack_require__(43);
var loadEditTemplate = __webpack_require__(44);
var loadTakeablesTemplate = __webpack_require__(45);
var loadRefreshTemplate = __webpack_require__(46);
var loadCreateSurveyFormTemplate = __webpack_require__(47);
var loadCreateButtonTemplate = __webpack_require__(48);

var addMessage = function addMessage(element, message) {
  $(element).html('');
  $(element).show();
...
var createSurveyFailure = function createSurveyFailure() {
  addMessage('.feedback-message', 'Error. Please try again.');
};

var loadSurveyForm = function loadSurveyForm() {
  var showSurveyFormHtml = loadCreateSurveyFormTemplate();
  $('.main').html('');
  $('.main').append(showSurveyFormHtml);
};

var rButton = function rButton() {
  var showRButtonHtml = loadRefreshTemplate();
  if ($('.refresh-survey').html('')) {
    $('.refresh-survey').append(showRButtonHtml);
  }
};

var crButton = function crButton() {
  var showCrButtonHtml = loadCreateButtonTemplate();
...
var dashboard = function dashboard(data) {
  ...
  otherSurveys.forEach(function (survey) {
    for (var i = 0; i < survey.submissions.length; i++) {
  ...
  mySurveys.forEach(function (survey) {
    survey.stats = {
      truth: 0,
      falsey: 0,
      total: 0
    };
    survey.submissions.forEach(function (submission) {
  ...
  return { mySurveys: mySurveys, takeableSurveys: takeableSurveys };
};

var getAllSurveysSuccess = function getAllSurveysSuccess(data) {
  $('.my-surv').html('');
  $('.take-surv').html('');

  var surveyDisplay = dashboard(data);

  var showSurveysHtml = loadSurveysTemplate({
    surveys: surveyDisplay.mySurveys
  });
  $('.my-surv').append(showSurveysHtml);
  var showTakeablesHtml = loadTakeablesTemplate({
...
var getAllSurveysFailure = function getAllSurveysFailure() {
  addMessage('.feedback-message', 'Error. Please try again.');
};

var getASurveySuccess = function getASurveySuccess(data) {
  $('.main').html('');
  var showEditHtml = loadEditTemplate({
    survey: data.survey
  });
  $('.main').append(showEditHtml);
};

var getASurveyFailure = function getASurveyFailure() {
  addMessage('.feedback-message', 'Error. Please try again.');
};
...
var deleteSurveySuccess = function deleteSurveySuccess(data) {
  var surveyDiv = $(data).parents('div')[0];
  $(surveyDiv).html('');
...
module.exports = {
  ...
  getAllSurveysSuccess: getAllSurveysSuccess,
  getAllSurveysFailure: getAllSurveysFailure,
...
var getAllSurveys = function getAllSurveys() {
  return $.ajax({
    url: config.apiOrigin + '/surveys',
    method: 'GET',
    headers: {
...
var getASurvey = function getASurvey(data) {
  var id = $(data).data('mySurveyId');
  return $.ajax({
...
var store = __webpack_require__(3);
var showMainTemplate = __webpack_require__(20);
var showSignedInNavTemplate = __webpack_require__(37);
var loadNavHeadTemplate = __webpack_require__(38);
var showNavTemplate = __webpack_require__(39);
var showSurveyContentTemplate = __webpack_require__(40);
var loadUserActionsTemplate = __webpack_require__(41);
var loadFeedbackMessageTemplate = __webpack_require__(42);
var survUi = __webpack_require__(6);
...
var signedInNav = function signedInNav() {
  $('.account-nav').html('');
  var showSignedInNavHtml = showSignedInNavTemplate();
  $('.account-nav').append(showSignedInNavHtml);
};

var navHeader = function navHeader() {
  var showNavHeaderHtml = loadNavHeadTemplate();
  $('.navbar-header').prepend(showNavHeaderHtml);
};

var surveyContent = function surveyContent() {
  var showSurveyContentHtml = showSurveyContentTemplate();
  $('.main').append(showSurveyContentHtml);
};

var userActions = function userActions() {
  $('.user-actions').html('');
  var showUserActionsHtml = loadUserActionsTemplate();
  $('.user-actions').append(showUserActionsHtml);
};

var feedbackMessageDiv = function feedbackMessageDiv() {
  var showFeedbackMessageHtml = loadFeedbackMessageTemplate();
...
var signInFailure = function signInFailure(error) {
  var errorStatus = error.status.toString();
...
var loadNav = function loadNav() {
  $('.signed-in-nav').html('');
  var showNavHtml = showNavTemplate();
  $('.signed-in-nav').append(showNavHtml);
};

var mainView = function mainView() {
  $('.main').html('');
  var showMainHtml = showMainTemplate();
...
var onGetAllSurveys = function onGetAllSurveys() {
  $('.main').html('');
  authUi.surveyContent();
  api.getAllSurveys().then(ui.getAllSurveysSuccess).catch(ui.getAllSurveysFailure);
};

var onGetASurvey = function onGetASurvey(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.getASurvey(data).then(ui.getASurveySuccess).catch(ui.getASurveyFailure);
};
...
var onDeleteSurvey = function onDeleteSurvey(event) {
  event.preventDefault();
  var surveyDiv = $(this).parent('.my-surveys');
  api.deleteSurvey(surveyDiv).then(function () {
    return ui.deleteSurveySuccess(surveyDiv);
...
var onEditSurvey = function onEditSurvey(event) {
  event.preventDefault();
  var surveyDiv = $(this).parent('.my-surveys');
  api.getASurvey(surveyDiv).then(ui.getASurveySuccess).catch(ui.getASurveyFailure);
};

var onLoadSurveyForm = function onLoadSurveyForm() {
  ui.loadSurveyForm();
};
...
module.exports = {
  ...
  onGetAllSurveys: onGetAllSurveys
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var submissionEvents = __webpack_require__(49);
...
var survApi = __webpack_require__(8);
var survUi = __webpack_require__(6);
...
var onSignIn = function onSignIn(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.signIn(data).then(ui.signInSuccess).then(survApi.getAllSurveys).then(survUi.getAllSurveysSuccess).catch(ui.signInFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"col-xs-6 form sign-in\">\n  <h5 class=\"text-center\">Sign-In</h5>\n  <form id=\"sign-in-form\" role=\"form\" autocomplete=\"off\">\n    <div class=\"form-group\">\n      <input type=\"text\" name=\"credentials[email]\" id=\"sign-in-email\" class=\"form-control input\" placeholder=\"Username\" value=\"\" autocomplete=\"off\" required>\n    </div>\n    <div class=\"form-group\">\n      <input type=\"password\" name=\"credentials[password]\" id=\"sign-in-password\" class=\"form-control input\" placeholder=\"Password\" autocomplete=\"off\" minlength=\"3\" required>\n    </div>\n    <div class=\"status-message-div\">\n      <p class=\"status-message-sign-in\"></p>\n    </div>\n    <div class=\"form-group\">\n      <div class=\"row\">\n        <div class=\"col-xs-6 col-xs-offset-3\">\n          <input type=\"submit\" name=\"login-submit\" id=\"sign-in-submit\" class=\"form-control btn btn-success\" value=\"Sign In\">\n        </div>\n      </div>\n    </div>\n  </form>\n</div>\n<div class=\"col-xs-6 form sign-up\">\n  <h5 class=\"text-center\">No Account? Sign-Up</h5>\n  <form id=\"sign-up-form\" autocomplete=\"off\">\n    <div class=\"form-group\">\n      <input type=\"text\" name=\"credentials[email]\" id=\"sign-up-email\" class=\"form-control input\" placeholder=\"Username\" value=\"\" required>\n    </div>\n    <div class=\"form-group\">\n      <input type=\"password\" name=\"credentials[password]\" id=\"sign-up-password\" class=\"form-control input\" placeholder=\"Password\" minlength=\"3\" required>\n    </div>\n    <div class=\"form-group\">\n      <input type=\"password\" name=\"credentials[password_confirmation]\" id=\"confirm-password\" class=\"form-control input\" placeholder=\"Confirm Password\" minlength=\"3\" required>\n    </div>\n    <div class=\"status-message-div\">\n      <p class=\"status-message-sign-up\"></p>\n    </div>\n    <div class=\"form-group\">\n      <div class=\"row\">\n        <div class=\"col-xs-6 col-xs-offset-3\">\n          <input type=\"submit\" name=\"submit\" id=\"sign-up-submit\" class=\"form-control btn btn-success\" value=\"Create Account\">\n        </div>\n      </div>\n    </div>\n  </form>\n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id=\"navbar\" class=\"collapse navbar-collapse\">\n  <ul class=\"nav navbar-nav navbar-right\">\n    <li class=\"dropdown\">\n      <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\">Change Password <span class=\"caret\"></span></a>\n      <ul class=\"dropdown-menu\" role=\"menu\">\n        <div class=\"col-lg-12\">\n          <div class=\"text-center\">\n            <h3><b>Change Password</b></h3></div>\n          <form id=\"change-password-form\" autocomplete=\"off\">\n            <div class=\"form-group\">\n              <input type=\"password\" name=\"passwords[old]\" id=\"old-password\" class=\"form-control input\" placeholder=\"Previous Password\" minlength=\"3\" required>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"password\" name=\"passwords[new]\" id=\"new-password\" class=\"form-control input\" placeholder=\"New Password\" minlength=\"3\" required>\n            </div>\n            <div class=\"status-message-div\">\n              <p class=\"status-message-change-password\"></p>\n            </div>\n            <div class=\"form-group\">\n              <div class=\"row\">\n                <div class=\"col-xs-6 col-xs-offset-3\">\n                  <input type=\"submit\" name=\"change-password-submit\" id=\"change-password-submit\" class=\"form-control btn btn-danger\" value=\"Confirm\">\n                </div>\n              </div>\n            </div>\n          </form>\n        </div>\n      </ul>\n    </li>\n    <li class=\"dropdown\">\n      <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\">Sign Out <span class=\"caret\"></span></a>\n      <ul class=\"dropdown-menu sign-out\" role=\"menu\">\n        <div class=\"col-xs-6 col-xs-offset-3\">\n          <div class=\"text-center\">\n          <input type=\"button\" name=\"sign-out-submit\" id=\"sign-out\" class=\"form-control btn btn-danger\" value=\"Sign Out\">\n          </div>\n        </div>\n      </ul>\n    </li>\n  </ul>\n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id=\"survey-content\" class=\"container-fluid surv\">\n  <div class=\"col-xs-12 survey-content\">\n    <div class=\"col-xs-8 my-surv\"></div>\n    <div class=\"empty-space-div col-xs-1\"></div>\n    <div class=\"col-xs-3 take-surv\"></div>\n  </div>\n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div id=\"user-actions\" class=\"container-fluid feedback\">\n  <div class=\"col-xs-12\">\n    <div class=\"col-xs-3 create-survey\"></div>\n\n    <div class=\"feedback-message-div col-xs-6\"></div>\n\n    <div class=\"col-xs-3 refresh-survey\"></div>\n  </div>\n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<p class=\"feedback-message\" style=\"text-align: center;\"></p>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"row\" style=\"margin-bottom: 2px; font-size: 15px;\">\n    <div data-my-survey-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"my-surveys surveys\">\n      <div style=\"color: #660066;\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + " </div>Total: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.stats : stack1)) != null ? stack1.total : stack1), depth0))
    + " True: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.stats : stack1)) != null ? stack1.truth : stack1), depth0))
    + " False: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.stats : stack1)) != null ? stack1.falsey : stack1), depth0))
    + "\n      <button type=\"button\" class=\"edit-survey\" name=\"button\">\n        Edit Me\n      </button>\n      <button type=\"button\" class=\"delete-survey\" name=\"button\">\n        Delete Me\n      </button>\n    </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<h4>My Surveys</h4>\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<button class=\"close-form\" style=\"float: right;\">Close</button>\n<form id=\"update-survey-form\">\n  <div class=\"form-group\">\n    <input type=\"hidden\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1._id : stack1), depth0))
    + "\" name=\"survey[_id]\" id=\"survey-update-id\" class=\"form-control input\">\n  </div>\n  <div class=\"form-group\">\n    <h3>Title:</h3>\n    <input type=\"text\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.title : stack1), depth0))
    + "\" name=\"survey[title]\" id=\"survey-update-title\" class=\"form-control input\" placeholder=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.title : stack1), depth0))
    + "\" minlength=\"1\" required>\n  </div>\n  <div class=\"form-group\">\n    <h3>Question:</h3>\n    <input type=\"text\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.question : stack1), depth0))
    + "\" name=\"survey[question]\" id=\"survey-update-height\" class=\"form-control input\" placeholder=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.question : stack1), depth0))
    + "\" minlength=\"1\" required>\n  </div>\n  <div class=\"form-group\">\n    <div class=\"row\">\n      <div class=\"col-xs-6 col-xs-offset-3\">\n        <input type=\"submit\" name=\"update-survey-submit\" id=\"update-survey-submit\" class=\"form-control btn btn-primary\" value=\"Confirm\">\n      </div>\n    </div>\n  </div>\n</form>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"row\" style=\"margin-bottom: 2px; font-size: 15px;\">\n    <div data-my-survey-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"take-surveys surveys take-style\">\n      "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\n      <button type=\"button\" class=\"take-survey\" name=\"button\">\n        Take Me\n      </button>\n    </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<h4>Surveys to Take</h4>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.surveys : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<button type=\"button\" class=\"refresh-survey-button\" name=\"button\" style=\"float: right;\">Refresh</button>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<button class=\"close-form\" style=\"float: right;\">Close</button>\n<h2 class=\"text-center\">Create A Survey</h2>\n<form id=\"create-survey-form\" autocomplete=\"off\">\n  <div class=\"form-group\">\n    <input type=\"text\" name=\"survey[title]\" id=\"survey-create-title\" class=\"form-control input\" placeholder=\"Survey Name\" required>\n  </div>\n  <div class=\"form-group\">\n    <input type=\"text\" name=\"survey[question]\" id=\"survey-create-question\" class=\"form-control input\" placeholder=\"True or False Question\" required>\n  </div>\n  <div class=\"form-group\">\n    <div class=\"row\">\n      <div class=\"col-xs-6 col-xs-offset-3\">\n        <input type=\"submit\" name=\"create-survey-submit\" id=\"create-survey-submit\" class=\"form-control btn btn-primary\" value=\"Confirm\">\n      </div>\n    </div>\n  </div>\n</form>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<button type=\"button\" class=\"create-survey-button\" style=\"float: left;\"name=\"button\">Create A Survey</button>\n";
},"useData":true});
...
var survApi = __webpack_require__(8);
var survEvents = __webpack_require__(12);
...
var onCreateSubmission = function onCreateSubmission(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createSubmission(data).then(function (data) {
...
var onTakeSurvey = function onTakeSurvey(event) {
  event.preventDefault();
  var takeableDiv = $(this).parent('div');
  survApi.getASurvey(takeableDiv).then(ui.displaySurveySuccess).catch(ui.displaySurveyFailure);
};
...
var store = __webpack_require__(3);
var loadCreateSubmissionTemplate = __webpack_require__(52);
var survUi = __webpack_require__(6);

var displaySurveySuccess = function displaySurveySuccess(data) {
  $('.main').html('');
  var showSubmissionContentHtml = loadCreateSubmissionTemplate({
    survey: data.survey
  });
  $('.main').append(showSubmissionContentHtml);
};

var displaySurveyFailure = function displaySurveyFailure() {
  survUi.addMessage('.feedback-message', 'Error. Please try again.');
};

var createSubmissionSuccess = function createSubmissionSuccess(data) {
  survUi.addMessage('.feedback-message', 'Your answer has been submitted!');
};

var createSubmissionFailure = function createSubmissionFailure() {
  survUi.addMessage('.feedback-message', 'Please choose an answer.');
};

module.exports = {
  createSubmissionSuccess: createSubmissionSuccess,
  createSubmissionFailure: createSubmissionFailure,
  displaySurveySuccess: displaySurveySuccess,
  displaySurveyFailure: displaySurveyFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<button class=\"close-form\" style=\"float: right;\">Close</button>\n<form id=\"create-submission-form\" autocomplete=\"off\">\n  <div class=\"form-group\">\n    <input type=\"hidden\" name=\"surveyid\" id=\"submission-surv-id\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1._id : stack1), depth0))
    + "\" class=\"form-control input\">\n  </div>\n  <div class=\"form-group\">\n    <h2>Question: <br> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.question : stack1), depth0))
    + "</h2>\n  </div>\n  <div class=\"form-group radio\">\n    <label class=\"radio-style\"><input type=\"radio\" name=\"submissions[answer]\" id=\"submission-answer-true\" class=\"form-control input true-radio\" value=\"true\">True</label>\n    <label class=\"radio-style\"><input type=\"radio\" name=\"submissions[answer]\" id=\"submission-answer-false\" class=\"form-control input false-radio\" value=\"false\">False</label>\n  </div>\n  <div class=\"form-group\">\n    <div class=\"row\">\n      <div class=\"col-xs-6 col-xs-offset-3\">\n        <input type=\"submit\" name=\"create-submission-submit\" id=\"create-submission-submit\" class=\"form-control btn btn-primary\" value=\"Submit Answer\">\n      </div>\n    </div>\n  </div>\n</form>\n";
},"useData":true});
